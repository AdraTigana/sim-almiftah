...
<?= $this->section('title') ?>Cetak Rapor<?= $this->endSection() ?>
...
<?= view('components/_breadcrumb', ['items' => [['label' => 'Dashboard', 'url' => $dashboardUrl], ['label' => 'Cetak Rapor']]]) ?>

<div class="flex items-center justify-between mb-6">
    <h3 class="font-headline-sm text-headline-sm text-primary">Cetak Rapor</h3>
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    ...
    <a href="<?= base_url($rolePrefix . '/cetak/rombel/' . $r['id']) ?>" class="glass-card p-6 rounded-2xl hover:bg-white transition-colors group">
        ...
        <span class="text-primary text-sm font-bold flex items-center gap-1">
            Cetak Rapor <span class="material-symbols-outlined text-sm">arrow_forward</span>
        </span>
    </a>
    <?php endforeach; ?>
    <?php else: ?>
